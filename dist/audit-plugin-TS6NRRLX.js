...
// src/core/audit-plugin.ts
import fs from "fs";
import path from "path";
var PLUGINS_DIR = ".opencode/plugins";
function generateAuditPlugin() {
...
function isSecretKey(key: string): boolean {
  const upper = key.toUpperCase().replace(/[-_s]/g, "_");
...
function installAuditPlugin(projectRoot, dryRun) {
...
//# sourceMappingURL=audit-plugin-TS6NRRLX.js.map